...
let feedGlobal = [

    {
        ...
        comentarios: [{user: "Fan1", text: "¡Increíble!"}]
...
function renderFeed(modo) {
    ...
    if(lista.length === 0) {
        ...
        contenedor.innerHTML = "<p style='text-align:center; color:#555;'>No hay videos aquí aún.</p>";
    ...
    lista.forEach(post => {
        ...
        card.innerHTML = `
            ...
            <div class="acciones">
                ...
                <button class="btn-icon" onclick="darLike(this)">❤️ ${post.likes}</button>

                <button class="btn-icon">💬 ${post.comentarios.length}</button>

                <button class="btn-icon" onclick="alert('Compartido!')">🔗</button>
            ...
            <div class="zona-extra">
                ...
                <div class="rec-box">
                    ...
                    <label><input type="radio" name="rec${post.id}"> Sí</label>
...
const supabaseUrl = 'AQUÍ_PEGA_TU_URL';sb_publishable_LXqbKyrtB1UfRB-9vvTHxA_tGnAHoNE
const supabaseKey = 'AQUÍ_PEGA_TU_CLAVE_API';const supabaseUrl = 'AQUÍ_PEGA_TU_URL';
const supabaseKey = 'AQUÍ_PEGA_TU_CLAVE_API';
